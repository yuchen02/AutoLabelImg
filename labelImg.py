...
from pytorch_yolov5.utils.dataloaders import *
from pytorch_yolov5.utils.general import *
from pytorch_yolov5.utils import torch_utils
from pytorch_yolov5.models.common import DetectMultiBackend
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def yolov5_auto_labeling(self):
        try:
            ...
            model = DetectMultiBackend(weights, device)  # load FP32 model
            names = model.module.names if hasattr(model, 'module') else model.names

            if len(names) == 1:
                needed_labels = names.values()
            else:
            ...
            if not OK:
                return
            imgsz = check_img_size(imgsz, s=model.stride)  # check img_size
            if half:
                model.half()  # to FP16
